...
export default function SeaFreightPage({ params }: { params: { locale: string } }) {
  const { locale } = params;
  ...
  const highlights = [
    { title: t('sea.h1Title'), desc: t('sea.h1Desc') },
    { title: t('sea.h2Title'), desc: t('sea.h2Desc') },
    { title: t('sea.h3Title'), desc: t('sea.h3Desc') },
    { title: t('sea.h4Title'), desc: t('sea.h4Desc') },
  ];
      ...
      <main> 
        ...
        >
          ...
          <div className="relative z-10 px-8 md:px-16 pb-10 md:pb-16">
            <h1 className="text-4xl md:text-6xl font-bold drop-shadow-lg mb-2">{t('sea.heroTitle')}</h1>
            <p className="text-blue-100 text-lg">{t('sea.heroSubtitle')}</p>
          </div>
        </section>
        ...
        <section className="py-14 px-4 bg-[#1B2A6B] text-white text-center">
          <h2 className="text-2xl font-bold mb-4">{t('sea.ctaTitle')}</h2>
          <p className="text-blue-200 mb-6 max-w-xl mx-auto">{t('sea.ctaSubtitle')}</p>
          <Link

...
export default function RoadTransportPage({ params }: { params: { locale: string } }) {
  const { locale } = params;
  ...
  const highlights = [
    { title: t('road.h1Title'), desc: t('road.h1Desc') },
    { title: t('road.h2Title'), desc: t('road.h2Desc') },
    { title: t('road.h3Title'), desc: t('road.h3Desc') },
    { title: t('road.h4Title'), desc: t('road.h4Desc') },
  ];
    ...
    <>
      ...
      <main>
        ...
        <section
          ...
          style={{ backgroundImage: "url('/images/duongbo.png')" }}
        >
          ...
          <div className="relative z-10 px-8 md:px-16 pb-10 md:pb-16">
            <h1 className="text-4xl md:text-6xl font-bold drop-shadow-lg mb-2">{t('road.heroTitle')}</h1>
            <p className="text-blue-100 text-lg">{t('road.heroSubtitle')}</p>
          </div>
        </section>
        ...
        <section className="py-14 px-4 bg-[#1B2A6B] text-white text-center">
          <h2 className="text-2xl font-bold mb-4">{t('road.ctaTitle')}</h2>
          <p className="text-blue-200 mb-6 max-w-xl mx-auto">{t('road.ctaSubtitle')}</p>
          <Link

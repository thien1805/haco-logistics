...
export default function CustomsPage({ params }: { params: { locale: string } }) {
  const { locale } = params;
  ...
  const highlights = [
    { title: t('customs.h1Title'), desc: t('customs.h1Desc') },
    { title: t('customs.h2Title'), desc: t('customs.h2Desc') },
    { title: t('customs.h3Title'), desc: t('customs.h3Desc') },
    { title: t('customs.h4Title'), desc: t('customs.h4Desc') },
  ];
      ...
      <main>
        ...
        >
          ...
          <div className="relative z-10 px-8 md:px-16 pb-10 md:pb-16">
            <h1 className="text-4xl md:text-6xl font-bold drop-shadow-lg mb-2">{t('customs.heroTitle')}</h1>
            <p className="text-blue-100 text-lg">{t('customs.heroSubtitle')}</p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-5">
                {t('customs.overviewP1')}
              </p>
              <p className="text-gray-600 leading-relaxed mb-8">
                {t('customs.overviewP2')}
              </p>
            </div>
        ...
        <section className="py-14 px-4 bg-[#1B2A6B] text-white text-center">
          <h2 className="text-2xl font-bold mb-4">{t('customs.ctaTitle')}</h2>
          <p className="text-blue-200 mb-6 max-w-xl mx-auto">{t('customs.ctaSubtitle')}</p>
          <Link
